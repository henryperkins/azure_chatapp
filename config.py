...
class Settings:
    ...
    DATABASE_URL = os.getenv(
        "DATABASE_URL",
        "postgresql+asyncpg://hperkins:Twiohmld1234!@azure-chatapp-dbserver.postgres.database.azure.com:5432/azure_chatapp?ssl=true&sslmode=verify-full&sslrootcert=DigiCertGlobalRootCA.crt",
    )
