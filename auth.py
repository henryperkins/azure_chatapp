...
# JWT Configuration
JWT_SECRET = "YOUR_JWT_SECRET_KEY"  # Replace with a secure random key in production
JWT_ALGORITHM = "HS256"
...
def get_current_user(token: str = Depends(lambda: None), db: Session = Depends(get_db)):
    """
    Retrieves the current user from JWT. Use as a FastAPI dependency where needed.
    Example usage:
       @router.get("/me")
