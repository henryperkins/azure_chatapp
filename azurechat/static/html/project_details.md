```html
<div id="projectDetailsView" class="project-details-root flex flex-col w-full max-w-6xl mx-auto p-2">
  <!-- Project overview card: groups header, actions, and stats in a visual card -->
  <section class="bg-base-100 rounded-box shadow-md border border-base-300 p-4 mb-6">
    ...
    <!-- Project stats panel -->
    <div id="projectStats" class="stats mb-4 sm:mb-6 project-stats" data-testid="project-stats">
      <div class="stat">
  ...
  <!-- Tab navigation now full width below card -->
  <div class="tabs mb-8 w-full flex justify-start gap-8" role="tablist" style="margin-left:2px;">
  ...
  <!-- Tab content -->
  <div id="projectTabContent" class="w-full">
  <!-- Details tab -->
  <div id="detailsTab" class="project-tab-content bg-base-100 rounded-box shadow-md border border-base-300 p-6 w-full" role="tabpanel" aria-labelledby="detailsTabBtn"
    tabindex="0">
  ...
  <div id="conversationsTab" class="project-tab-content hidden" role="tabpanel"
    ...
    <div id="projectChatContainer" class="mt-4 transition-all duration-300 ease-in-out">
      <div class="flex justify-between items-center mb-2">
        ...
        <div id="projectChatUI" class="bg-base-100 rounded-box shadow-md border border-base-200">
          <div class="chat-title-row flex items-center justify-between py-2 px-4 border-b border-base-200 bg-base-100/70">
            <span id="projectChatTitle">Current Conversation Title</span>
            <button id="projectChatTitleEditBtn" aria-label="Edit title" class="btn btn-ghost btn-xs px-2 h-7 focus:ring-2 focus:ring-primary">
              <svg xmlns="http://www.w3.org/2000/svg" class="h-4 w-4" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536M9 11l6 6M5 19l2.828-2.828M2 12.414l8.293-8.293a1 1 0 011.414 0l8.293 8.293a1 1 0 010 1.414l-8.293 8.293a1 1 0 01-1.414 0L2 13.828a1 1 0 010-1.414z" />
              </svg>
              <span class="sr-only">Edit Chat Title</span>
            </button>
          </div>
        <div class="chat-container">
          <div id="projectChatMessages" class="chat-message-container" aria-live="polite" tabindex="0"></div>
          <div class="flex items-center border-t border-base-200 p-2 bg-base-100 sticky bottom-0 z-10 rounded-b-box shadow-xs join">
            <input id="projectChatInput"
                   type="text"
                   class="join-item flex-1 input input-bordered rounded-l-full px-4 py-3 text-base bg-base-200 focus:ring-2 focus:ring-primary transition-all"
                   ...
                   maxlength="1000"
                   />
            <button id="projectChatSendBtn"
                    type="button"
                    class="join-item btn btn-primary px-6 h-12 min-w-[44px] rounded-r-full rounded-l-none shadow-md hover:shadow-lg btn-icon flex items-center gap-2 text-base transition-all"
                    aria-label="Send message">
              <svg class="h-5 w-5 mr-0" fill="none" stroke="currentColor" stroke-width="2" viewBox="0 0 24 24">
                  <path stroke-linecap="round" stroke-linejoin="round" d="M5 12l14-5-5 14-2.6-4.06L5 12z"/>
              </svg>
    ...
    <div id="projectConversationsList" class="mt-4 flex flex-col gap-2 bg-base-100 rounded-box shadow-xs border border-base-200 p-2 max-h-[50vh] overflow-y-auto transition-all">
    ...
    <div id="knowledgeBaseStatus" class="mb-6 p-4 bg-base-200 rounded-box">
      ...
      <div id="knowledgeBaseActive" class="hidden">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-4 mb-3">
          ...
          <div class="bg-base-100 p-3 rounded-box shadow-xs">
            <div class="text-2xl font-semibold mb-1" id="kbModelDisplay">Not Set</div>
            <div class="text-xs text-base-content/60">Embedding Model</div>
          </div>
...
<dialog id="errorModal" class="modal">
  <form method="dialog" class="modal-box">
    <h3 id="errorModalTitle"   class="font-bold text-lg mb-2">Error</h3>
    <p  id="errorModalMessage" class="py-2"></p>
    <button class="btn btn-primary mt-4" data-modal-dismiss>Close</button>
  </form>
</dialog>
