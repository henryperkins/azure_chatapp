...
@layer utilities {
  ...
  .floating-label {
    ...
    &:not(:has(input:-moz-placeholder, textarea:-moz-placeholder)) {
      ::placeholder {
        opacity: 0%;
        top: 0;
...
body.with-sidebar-open .notification-area, body.with-sidebar-open #notificationArea {
...
.notification-item, .alert.notification-item, .accordion-banner {
...
.notification-item.info, .accordion-banner.notification-info {
...
.notification-item.success, .accordion-banner.notification-success {
...
.notification-item.error, .accordion-banner.notification-error {
...
.notification-item.warning, .accordion-banner.notification-warning {
...
.notification-copy-btn, .notification-close, .accordion-copy-btn, .accordion-dismiss-btn, .accordion-banner .btn-xs {
...
.notification-copy-btn:active, .notification-close:active, .accordion-copy-btn:active, .accordion-dismiss-btn:active {
  color: #1768c9 !important;
}
@media (max-width: 640px) {
  .notification-copy-btn, .notification-close, .accordion-copy-btn, .accordion-dismiss-btn {
...
.notification-copy-btn:focus-visible, .notification-close:focus-visible, .accordion-copy-btn:focus-visible, .accordion-dismiss-btn:focus-visible {
...
.accordion-banner .accordion-message-list.expanded, .accordion-banner.expanded .accordion-message-list {
...
.accordion-banner .collapse-title, .accordion-banner .accordion-summary-text {
...
[data-theme*="dracula"] .notification-copy-btn:focus-visible, [data-theme*="dracula"] .notification-close:focus-visible, [data-theme*="dracula"] .accordion-copy-btn:focus-visible, [data-theme*="dracula"] .accordion-dismiss-btn:focus-visible, [data-theme*="dracula"] .notification-clear-all:focus-visible, .notification-copy-btn:focus-visible, .notification-close:focus-visible, .accordion-copy-btn:focus-visible, .accordion-dismiss-btn:focus-visible {
...
:root {
  --notif-group-bg: #83eaff;
  --notif-dim-opacity: .6;
}
html[data-theme="dark"] {
  --notif-group-bg: #226b81;
}
...
html[data-theme="dark"] {
  .notification-item .notification-message, .alert.notification-item .notification-message, .accordion-banner .collapse-title, .accordion-banner .accordion-summary-text, .accordion-banner .notification-context-badge, .accordion-banner .accordion-message-list li, .accordion-banner .accordion-message-list {
  ...
  .notification-item.info, .accordion-banner.notification-info {
    border-left-color: #4ec9fa !important;
  }
  .notification-item.success, .accordion-banner.notification-success {
    border-left-color: #90efb7 !important;
  }
  .notification-item.error, .accordion-banner.notification-error {
    border-left-color: #fa7ea6 !important;
  }
  .notification-item.warning, .accordion-banner.notification-warning {
    border-left-color: #ffcb6b !important;
  }
}
